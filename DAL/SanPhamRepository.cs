...
namespace DAL
{
    public partial class SanPhamRepository : ISanPhamRepository
    {
        ...
        public List<SanPhamModel> GetDataSameItem(string Maloai)
        {
            ...
            try
            {
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_sanpham_same_type", "@item_group_id", Maloai);
                if (!string.IsNullOrEmpty(msgError))
                    throw new Exception(msgError);
                return dt.ConvertTo<SanPhamModel>().ToList();
            }
        ...
        public List<SanPhamModel> Search1(int pageIndex, int pageSize, out long total, string Tensp)
        {
            ...
            try
            {
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_sanpham_searchadmin",
        ...
        public List<SanPhamModel> GetSpKM()
        {
            ...
            try
            {
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_spkm");
                if (!string.IsNullOrEmpty(msgError))
                    throw new Exception(msgError);
                return dt.ConvertTo<SanPhamModel>().ToList();
            }
        ...
        public List<SanPhamModel> GetSpTOT()
        {
            ...
            try
            {
                var dt = _dbHelper.ExecuteSProcedureReturnDataTable(out msgError, "sp_sptotnhat");
                if (!string.IsNullOrEmpty(msgError))
                    throw new Exception(msgError);
                return dt.ConvertTo<SanPhamModel>().ToList();
            }
